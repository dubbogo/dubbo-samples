...
import (
	...
	dubbo32 "github.com/apache/dubbo-samples/golang/general/dubbo3/protobuf/dubbo3"
)

type GrpcGreeterImpl struct {
	Dubbo3SayHello func(ctx context.Context) (dubbo32.Dubbo3Greeter_Dubbo3SayHelloClient, error)
}
